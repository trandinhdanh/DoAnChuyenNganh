...
public class ExamResutController {
    ...
    public ExamResultDTO save(@RequestBody ExamResultDTO dto, @PathVariable long idExam, @PathVariable long idStudent) {
        return iExamResultService.save(dto, idExam, idStudent);
    }
